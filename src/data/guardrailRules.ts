...
export const guardrailRules: GuardrailRule[] = [
  // ─── Color ───
  {
    ...
    checkDescription: "For Helmut only, verify Antique Bronze (#C69B5B) stays below 8% of surface area. Olga uses #C9A962 by role, not by this ratio.",
    status: "pass",
    weight: 0.8,
  },
  {
  ...
  },
  {
    ...
    category: "color",
    severity: "warning",
    description: "Neutral surfaces (canvas, stone) must dominate. Terracotta for interaction and emphasis surfaces only — never for text, labels, icons, map elements, or borders. Deep green for structure only. Bronze for highlights only. No blue tones.",
    checkDescription: "Verify neutral surfaces fill 80%+ of visible area with no colored backgrounds.",
    status: "pass",
    weight: 0.5,
  },
  {
    id: "color-terracotta-usage",
    name: "Terracotta interaction only",
    category: "color",
    severity: "error",
    description: "Terracotta (#C35C3C) is restricted to interactive elements (buttons, CTAs, active/selected states) and emphasis surfaces (highlight panels, callout sections). Strictly prohibited for: typography (body, headings, labels, tags, pills), map elements (markers, icons, routes, overlays), system/navigation icons, borders, dividers, and neutral backgrounds.",
    checkDescription: "Flag any terracotta usage outside of buttons, CTAs, active states, or emphasis panels.",
    status: "pass",
    weight: 0.8,
  },
  {
    id: "cta-terracotta-on-green",
    name: "No Terracotta CTA on green",
    category: "color",
    severity: "error",
    description: "Terracotta CTAs are prohibited on Deep Green backgrounds. Use Champagne Bronze (primary) or white/cream (secondary). Defined in Interaction → CTA System.",
    checkDescription: "Flag any Terracotta button/CTA placed on a bg-deep-green surface.",
    status: "pass",
    weight: 0.9,
  },
  {
    id: "cta-bronze-on-terracotta",
    name: "No Bronze CTA on terracotta",
    category: "color",
    severity: "error",
    description: "Bronze CTAs are prohibited on Terracotta surfaces. Use Base Canvas (cream) with dark text or white outline. Defined in Interaction → CTA System.",
    checkDescription: "Flag any Bronze button/CTA placed on a bg-primary surface.",
    status: "pass",
    weight: 0.9,
  },
  {
    id: "cta-low-contrast",
    name: "CTA must contrast background",
    category: "color",
    severity: "error",
    description: "CTA color must never match its container background (e.g. green on green, terracotta on terracotta). CTA must always carry the highest contrast in its context.",
    checkDescription: "Flag any CTA where button color matches or is close to its container background.",
    status: "pass",
    weight: 1.0,
  },
  {
    id: "cta-multi-accent",
    name: "One accent per CTA area",
    category: "color",
    severity: "error",
    description: "Only one accent color is allowed per container. Do not mix Bronze + Terracotta, or stack warm/dominant colors in the same interaction layer.",
    checkDescription: "Flag any interaction area combining two or more dominant warm/accent colors.",
    status: "pass",
    weight: 0.9,
  },
  {
    id: "cta-cream-no-cradle",
    name: "Cream env: no bronze cradle",
    category: "color",
    severity: "error",
    description: "On Base Canvas and Warm Stone surfaces, Terracotta CTAs must appear directly — never wrapped in a bronze supporting surface.",
    checkDescription: "Flag any .cta-cradle usage on bg-background or bg-card surfaces.",
    status: "pass",
    weight: 0.8,
  },
  {
  ...
  },
  {
    ...
    category: "typography",
    severity: "error",
    description: "All product body text, labels, and UI copy must use Lexend.",
    checkDescription: "Verify all non-heading product text uses font-body (Lexend).",
    status: "pass",
    weight: 0.7,
  },
  {
