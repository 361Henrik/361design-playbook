...
export const guardrailRules: GuardrailRule[] = [
  ...
  {
    id: "color-env-green-cta",
    name: "Green env: bronze/cream CTA",
    category: "color",
    severity: "error",
    description: "On Deep Green backgrounds, primary CTA must be Champagne Bronze (solid). Secondary CTA: white fill with bronze outline, or cream. Terracotta CTAs are prohibited on green surfaces.",
    checkDescription: "Flag any Terracotta button/CTA placed on a bg-deep-green surface.",
    status: "pass",
    weight: 0.9,
  },
  {
    id: "color-env-cream-no-cradle",
  ...
  {
    id: "color-no-warm-stacking",
    name: "No warm color stacking",
    category: "color",
    severity: "error",
    description: "Do not stack warm or dominant colors in the same interaction layer. Prohibited combinations: Terracotta on Bronze, Terracotta on Green, Bronze behind Terracotta on Cream.",
    checkDescription: "Flag any interaction area combining two or more dominant warm colors.",
    status: "pass",
    weight: 0.9,
  },
  {
