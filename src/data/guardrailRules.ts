...
export const guardrailRules: GuardrailRule[] = [
  ...
  },
  {
    ...
    name: "Green env: cream CTA only",
    category: "color",
    severity: "error",
    description: "On Deep Green backgrounds, only Cream or White CTA buttons are permitted. Terracotta and Bronze CTAs are prohibited on green surfaces.",
    checkDescription: "Flag any Terracotta or Bronze button/CTA placed on a bg-deep-green surface.",
    status: "pass",
    weight: 0.9,
  },
  {
