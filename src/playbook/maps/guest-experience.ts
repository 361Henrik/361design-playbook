...
export const guestExperiencePlaybook: PlaybookPage = {
  ...
  description: "Guest-facing map design for mature travelers. Every design decision prioritizes clarity, comfort, and confidence for outdoor use on older smartphone screens.",
  status: "complete",
  openQuestions: [],
  content: [
    {
      ...
      body: "This section defines map interface rules for the guest-facing experience. The primary map audience is cruise guests aged 65–85. Every design decision must prioritize clarity, comfort, and confidence for this demographic.\n\nThese are interface behavior rules — they apply regardless of which operator is configured.",
    },
    {
      type: "text",
    ...
    {
      type: "text",
      heading: "Outdoor Readability",
      body: "The map must be extremely readable in outdoor environments and on older smartphone screens. This means:\n\n• High contrast markers (white disk, black ring, black icon)\n• No reliance on subtle color differentiation\n• Labels large enough to read in bright sunlight\n• No fine detail that disappears on lower-resolution screens",
    },
    {
      type: "rule-list",
    ...
    },
    {
      ...
      dos: [
        ...
        "Ensure markers remain visible and legible in bright sunlight",
      ],
      donts: [
        ...
        "No reliance on color alone to differentiate marker categories",
      ],
    },
  ],
};
