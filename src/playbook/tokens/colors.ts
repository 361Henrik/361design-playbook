...
export const colorsPlaybook: PlaybookPage = {
  ...
  content: [
    ...
    {
      type: "text",
      heading: "Unified CTA Color System",
      body: "CTA color is determined in two steps: **Environment** (background context) defines the primary CTA, then **Container style** (filled or outlined) refines behavior.\n\n## Step 1 — Environment\n\n### Green Environment (Deep Green backgrounds)\nUsed for hero sections, navigation surfaces, and anchor panels.\n- **Primary CTA:** Champagne Bronze (#C9A962), solid.\n- **Secondary CTA:** White fill with bronze outline.\n- **Optional:** Bronze CTA cradle at ~12–15% opacity as supporting surface.\n- **Prohibited:** Terracotta CTAs. Bronze + Terracotta combinations.\n\n### Cream Environment (Base Canvas / Warm Stone)\nUsed for main content areas and reading surfaces.\n- **Primary CTA:** Terracotta (#C35C3C), solid.\n- **Optional:** Green or Bronze CTA allowed ONLY if defined by container (see Step 2).\n- **Prohibited:** Bronze used arbitrarily without container logic. Green CTA without container context.\n\n### Terracotta Environment (rare, controlled)\nUsed for emphasis panels and highlight sections.\n- **Primary CTA:** Base Canvas (cream) fill with dark text.\n- **Secondary CTA:** White outline.\n- **Prohibited:** Bronze CTAs. Green CTAs. Terracotta-on-terracotta.\n\n## Step 2 — Container Behavior\n\nEach container defines a single accent color (Green, Terracotta, or Bronze). CTA adapts based on container style:\n\n### Filled Container (Green or Terracotta)\n- **CTA:** Neutral — Base Canvas (cream) fill with dark text, or white outline.\n- **Prohibited:** CTA using same color as background (green on green, terracotta on terracotta).\n\n### Outlined Container (Green, Terracotta, or Bronze border)\n- **CTA:** May use the same color as the outline — filled button in that color, or outline button.\n- This is the ONLY case where colored CTAs are allowed outside default environment rules.\n\n### Neutral Container (Base Canvas)\n- **CTA:** Default Terracotta (primary CTA).\n- May inherit Green or Bronze ONLY if clearly defined by container accent.\n\n## Global Rules\n- Only one accent color per container.\n- Do not stack warm or dominant colors in the same interaction layer.\n- Avoid Bronze + Terracotta combinations.\n- CTA must always have the highest contrast in its context.\n- Visual priority: Background defines environment → Container refines behavior → CTA contrasts clearly.",
    },
    {
      type: "do-dont",
