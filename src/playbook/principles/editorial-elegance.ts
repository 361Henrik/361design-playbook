    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Neutral base always dominant. Terracotta for interaction only. Deep green for structural emphasis. Bronze for subtle highlights. No blue tones — surfaces are always base canvas, stone, or white.",
        },
        {
          title: "Subtle Depth",
          description:
