  ...
  content: [
    {
      ...
      heading: "Color Rules",
      rows: [
        { label: "Surface bronze isolated", value: "Error", notes: "Helmut #C69B5B never exceeds 8%; Olga #C9A962 follows its role contract. Never swap them." },
        { label: "No gradients", value: "Error", notes: "Gradients are prohibited. Use flat, solid color fills only." },
        { label: "Approved surface palette only", value: "Error", notes: "Use exactly one selected surface contract; never merge Helmut and Olga tokens." },
        { label: "Helmut 60/30/8 distribution", value: "Warning", notes: "Helmut follows 60% Warm White / 30% Forest / no more than 8% Antique Bronze." },
    ...
    },
    {
      ...
      rows: [
        { label: "Surface target minimum", value: "Error", notes: "Helmut is 48×48px (52px maps); Olga is 44×44px." },
        ...
        { label: "No image text overlays", value: "Error", notes: "Place text beside imagery or on a solid token-backed panel." },
